...
**경쟁 제품 7개와 직접 실측** (같은 코퍼스·같은 모델, [방법론](BENCHMARKS.md)) —
2026년 최대 화제작 둘 포함 (LightRAG 37.6k★, MemPalace 57.2k★):
...
| 인제스트 (54노트) | **LLM 0콜·~30초** | 165콜·14분 | 로컬 임베딩 | 노트당 1-2콜 | ~45분 | API측 | 0 | 0 |
