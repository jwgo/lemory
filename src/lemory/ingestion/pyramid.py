...
_SCENE_PROMPT = (
    ...
    "'## 전개'에 바뀐 흔적을 남겨라.\n"
    "- 기억에 없는 내용을 지어내지 마라.\n"
    "- 계산 금지: 수치를 더하거나 유도하지 마라. '강아지 2마리'와 '강아지 "
    "렉스'가 오면 3마리로 갱신하지 마라 · 렉스가 그 둘 중 하나인지 알 수 "
    "없다. 수치는 새 기억이 명시적으로 말할 때만 바꾼다.\n"
    "- 사건 기록 보존: 팔았다/죽었다/이사했다/바꿨다 같은 사건 기록은 "
    "지우지 말고 '## 전개'에 남긴다.\n"
...
_PERSONA_PROMPT = (
    ...
    "섹션은 비워도 된다.\n"
    "- 같은 사실의 최신 진술이 이전 진술을 대체한다. 평균 내거나 합치지 "
    "말고, 명시적 날짜가 붙은 옛 값보다 더 최근 언급을 따른다.\n"
